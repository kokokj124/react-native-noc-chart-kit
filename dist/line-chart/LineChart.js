    ...
    LineChart.prototype.render = function () {
        ...
        <Svg height={height + paddingBottom + legendOffset} width={width - margin * 2 - marginRight}  onPress={() => {
          ...
          <G x="0" y={legendOffset}>
            ...
            <G>
              {withVerticalLabels &&
            this.renderVerticalLabels(__assign(__assign({}, config), { labels: labels, paddingTop: paddingTop, paddingRight: paddingRight + 10, formatXLabel: formatXLabel }))}
            </G>
            <G>
              {this.renderLine(__assign(__assign(__assign({}, config), chartConfig), { paddingRight: paddingRight + 10, paddingTop: paddingTop, data: data.datasets }))}
            </G>
            <G>
              {withShadow &&
