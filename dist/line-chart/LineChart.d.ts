...
export interface LineChartProps extends AbstractChartProps {
     ...
     */
    getDotColor?: (dataPoint, index: number) => string;
    /**
     ...
     */
    getDotProps?: (dataPoint, index: number) => object;
    /**
...
declare class LineChart extends AbstractChart<LineChartProps, LineChartState> {
    ...
    getPropsForDots: (x, i: number) => object;
    ...
    renderLegend: (width, legendOffset) => JSX.Element[];
    render(): JSX.Element;
}
